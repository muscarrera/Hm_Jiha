Public Class RPanel
    ...
    Public Sub AddItems(ByVal D As DataTable, ByVal isSell As Boolean)
        ...
        End Try
    End Sub
    Public Sub OrderItems()
        If Form1.cbOrderCtg.Checked = False Then Exit Sub
        Dim a As Items
        For Each a In Pl.Controls
            If a.cid = 2 Then a.SendToBack()
            If a.cid = 3 Then a.BringToFront()
        Next
        For Each a In Pl.Controls
            If a.cid = 1 Then a.SendToBack()
            If a.cid > 3 Then a.BringToFront()
        Next
    End Sub
