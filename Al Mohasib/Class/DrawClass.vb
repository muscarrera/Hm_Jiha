Public Class DrawClass
    ...
    Public Sub DrawBon(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal dt As DataTable, ByVal fid As Integer, ByVal clid As Integer,
        ...
        Else
            If Form1.cbBonToFact.Checked Then
                ...
                '    DrawFactureWithRemise(e, RPl.DataSource, RPl.FctId, RPl.ClientName, RPl.ClientAdresse,
                '                                                       RPl.Total_Ht, RPl.Total_TTC, RPl.Tva, RPl.isSell, RPl.bl, dte, RPl.Remise, False, RPl.bl, myTva, m)

                'Else
                '    DrawFacture2(e, RPl.DataSource, RPl.FctId, RPl.ClientName, RPl.ClientAdresse,
                '                                      RPl.Total_Ht, RPl.Total_TTC, RPl.Tva, RPl.isSell, RPl.bl, dte, RPl.Remise, False, RPl.bl, myTva, m)
                'End If
            ...
            Else
                ...
                End If
                'a.DrawBL(e, RPl.DataSource, RPl.FctId, RPl.ClId, RPl.ClientName, RPl.ClientAdresse,
                'RPl.Total_Ht, RPl.Total_TTC, RPl.Tva, RPl.isSell, dte, RPl.Remise, M)
            End If
        End If
    ...
    Public Sub DrawBL_A5_Ar(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal dt As DataTable, ByVal fid As Integer, ByVal clid As Integer,
        ...
        Dim myPoints() As Point = New Point() {New Point(60 * a, 160 * a), New Point(600 * a, 160 * a),
                                               New Point(612 * a, 175 * a), New Point(600 * a, 190 * a),
                                               New Point(60 * a, 190 * a)}
        e.Graphics.FillPolygon(Brushes.WhiteSmoke, myPoints)
        e.Graphics.DrawPolygon(New Pen(Brushes.Gainsboro, 0.5F), myPoints)

        myPoints = {New Point(606 * a, 160 * a), New Point(770 * a, 160 * a),
                   New Point(770 * a, 190 * a), New Point(606 * a, 190 * a),
                   New Point(618 * a, 175 * a)}
        e.Graphics.FillPolygon(Brushes.Gainsboro, myPoints)
        e.Graphics.DrawPolygon(New Pen(Brushes.Gainsboro, 0.5F), myPoints)

        'print date 
        e.Graphics.DrawString(dte, fnt, Brushes.Black, New RectangleF(600 * a, 167 * a, 164 * a, 30), sf1)
        'print  num Facture 
        If isSell Then
            If isDevis Then
                e.Graphics.DrawString("Devis  N° : " & fctid, fntTitle, Brushes.Black, 65 * a, 165 * a)

            Else
                e.Graphics.DrawString("Bon de Livraison  N° : " & fctid, fntTitle, Brushes.Black, 65 * a, 165 * a)

            End If
        Else
            e.Graphics.DrawString("Bon de Commande  N° : " & fctid, fntTitle, Brushes.Black, 65 * a, 165 * a)
        End If

        Try
            'print Client 
            e.Graphics.DrawString("M : " & clientName, fnt, Brushes.Black, 65 * a, 200 * a)
            e.Graphics.DrawString(CAdresse, fnt, Brushes.Black, 65 * a, 215 * a)

        Catch ex As Exception

        End Try

        If m > 0 Then e.Graphics.DrawString("[ ..... ]", fnt, Brushes.Black, 60 * a, 230 * a)

        'Draw the table  e.MarginBounds.Height
        e.Graphics.FillRectangle(Brushes.WhiteSmoke, CInt(60 * a), CInt(l * a), CInt(710 * a), 25)
        'e.Graphics.DrawRectangle(pen, CInt(60 * a), CInt(l * a), CInt(710 * a), CInt(600 * a))
        e.Graphics.DrawRectangle(pen, CInt(60 * a), CInt(l * a), CInt(710 * a), e.MarginBounds.Height - CInt(l * a))
        e.Graphics.DrawLine(pn, CInt(60 * a), CInt((l * a) + 25), CInt(770 * a), CInt((l * a) + 25))

        'e.Graphics.DrawLine(pn, 420, l, 420, 850)
        e.Graphics.DrawLine(pn, CInt(201 * a), CInt(l * a), CInt(201 * a), e.MarginBounds.Height) ' CInt(850 * a))
        e.Graphics.DrawLine(pn, CInt(282 * a), CInt(l * a), CInt(282 * a), e.MarginBounds.Height)
        e.Graphics.DrawLine(pn, CInt(697 * a), CInt(l * a), CInt(697 * a), e.MarginBounds.Height)

        e.Graphics.DrawString("المواد", fnt, Brushes.Black, New RectangleF(284 * a, (l + 5) * a, 410 * a, 25), sf2)
        'e.Graphics.DrawString("Unite", fnt, Brushes.Black, New RectangleF(420, l + 5, 55, 25), sf2)
        e.Graphics.DrawString("الكمية", fnt, Brushes.Black, New RectangleF(699 * a, (l + 5) * a, 71 * a, 25), sf2)
        e.Graphics.DrawString("الثمن", fnt, Brushes.Black, New RectangleF(203 * a, (l + 5) * a, 76 * a, 25), sf2)
        e.Graphics.DrawString("المجموع ", fnt, Brushes.Black, New RectangleF(62 * a, (l + 5) * a, 136 * a, 25), sf2)
        ...
        While m < data.Rows.Count
            ...
            If re > 0 Then prdName &= " *(Remise:" & String.Format("{0:n}", re) & "%)*"
    ...
    Public Sub DrawBL_A5_Fr(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal dt As DataTable, ByVal fid As Integer, ByVal clid As Integer,
        ...
        'e.Graphics.DrawLine(pn, 420, l, 420, 850)
        e.Graphics.DrawLine(pn, CInt(470 * a), CInt(l * a), CInt(470 * a), e.MarginBounds.Height) ' CInt(850 * a))
        e.Graphics.DrawLine(pn, CInt(542 * a), CInt(l * a), CInt(542 * a), e.MarginBounds.Height)
        e.Graphics.DrawLine(pn, CInt(618 * a), CInt(l * a), CInt(618 * a), e.MarginBounds.Height)

        e.Graphics.DrawString("Designation", fnt, Brushes.Black, New RectangleF(62 * a, (l + 5) * a, 410 * a, 25), sf2)
        'e.Graphics.DrawString("Unite", fnt, Brushes.Black, New RectangleF(420, l + 5, 55, 25), sf2)
        e.Graphics.DrawString("Qte", fnt, Brushes.Black, New RectangleF(472 * a, (l + 5) * a, 71 * a, 25), sf2)
        e.Graphics.DrawString("Prix", fnt, Brushes.Black, New RectangleF(544 * a, (l + 5) * a, 76 * a, 25), sf2)
        e.Graphics.DrawString("Total ", fnt, Brushes.Black, New RectangleF(620 * a, (l + 5) * a, 136 * a, 25), sf2)
        ...
        While m < data.Rows.Count
            ...
            Dim ref As String = data.Rows(m).Item("code")
            Dim prdName As String = "[" & ref & "] " & data.Rows(m).Item("name")
            'Dim unite As String = data.Rows(m).Item("unite")
            Dim qte As String = data.Rows(m).Item("qte")
            Dim price As String = String.Format("{0:n}", CDec(data.Rows(m).Item("price")))
            Dim total As String = String.Format("{0:n}", CDec(data.Rows(m).Item("total")))
    ...
    Public Sub DrawBL_A5_Ar_Separated(ByRef e As System.Drawing.Printing.PrintPageEventArgs,
                                      ByVal dt As DataTable, ByVal fid As Integer, ByVal clid As Integer,
                                      ByVal CName As String, ByVal dte As String, ByVal totalGen As String,
                                      ByVal t As Integer, ByVal a As Double)
        ...
        Dim title As String = " *** حــــمـــام بــــلــــدي ***"
        If t = 2 Then title = "الـحــلاقــة"
        If t = 3 Then title = "الـتــركــي"
        If t = 4 Then title = "الــمـــواد"
        ...
        Dim myPoints() As Point = New Point() {New Point(10, 150), New Point(270, 150),
                                               ...
                                               New Point(10, 180)}
        '  e.Graphics.FillPolygon(Brushes.WhiteSmoke, myPoints)
        e.Graphics.DrawPolygon(New Pen(Brushes.Black, 1.0F), myPoints)
        ...
        If t = 1 Then
            ...
            e.Graphics.DrawRectangle(New Pen(Brushes.Black, 3), 5, l, 280, 35)
            e.Graphics.DrawString(title, New Font("Times New Roman", 17, FontStyle.Bold), Brushes.Black, New RectangleF(5, l + 5, 280, 25), sf2)

            l = l + 10
        Else
            e.Graphics.FillRectangle(Brushes.Black, 5, l, 280, 25)
            e.Graphics.DrawString(title, New Font(fnt, FontStyle.Bold), Brushes.White, New RectangleF(5, l + 5, 280, 25), sf2)
        ...
        While m < data.Rows.Count
            ...
            If data.Rows(m).Item("cid") <> t Then
                If t <> 4 Or data.Rows(m).Item("cid") < 4 Then
                    m += 1
                    Continue While
                End If
            End If
            ...
            ''''''
            totalttc += CDec(data.Rows(m).Item("price") * data.Rows(m).Item("qte"))
        ...
        e.Graphics.DrawString("*****  " & v & " - Vidals    |    " & q & "العــدد ", fnt, Brushes.Black, 15, 230)

        Dim ttc As String = String.Format("{0:n}", CDec(totalttc))
        Dim _ttc As String = String.Format("{0:n}", CDec(totalGen))


        Dim avc As String = String.Format("{0:n}", CDec(Form1.payedCache))
        Dim rest As String = String.Format("{0:n}", CDec(totalGen - Form1.payedCache))
        ...
        l += 50
        e.Graphics.DrawString("Total General : " & _ttc & " (Dhs)", fnt, Brushes.Black, New RectangleF(10, l, 200, 22), sf)
    ...
    Public Sub DrawReceipt(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal dt As DataTable, ByVal fid As Integer,
        ...
        e.Graphics.DrawString(Form1.txttitle.Text, fntTitle, Brushes.Black, New RectangleF(10, 20, 500, 55), sf2)
        e.Graphics.DrawString(Form1.txtAdrs.Text, fnt, Brushes.Black, New RectangleF(10, 80, 500, 30), sf2)
        e.Graphics.DrawString(Form1.txttel.Text, fnt, Brushes.Black, New RectangleF(10, 100, 500, 30), sf2)
        ...
        While m < data.Rows.Count
            ...
            Dim ref As String = data.Rows(m).Item("code")
            Dim cid As String = data.Rows(m).Item("cid")
            ...
            If ref.Length > 0 And cid < 4 Then
                l = l + size.Height
                e.Graphics.DrawString(ref, New Font("Arial", fnt.Size - 2, FontStyle.Italic), Brushes.Black, New RectangleF(55, l, 120, size.Height), sf)
            End If
        ...
        If BL <> "" Or BL <> "-" Or BL <> "---" Then
            e.Graphics.DrawString("------  *****  ------", fnt, Brushes.Black, New RectangleF(10, l, 200, 22), sf2)
            e.Graphics.DrawString("Charger par : " & BL, fnt, Brushes.Black, New RectangleF(10, l + 12, 200, 22), sf2)
            e.Graphics.DrawString("------  *****  ------", fnt, Brushes.Black, New RectangleF(10, l + 25, 200, 22), sf2)
    ...
    Public Sub DrawReceipt_Ar(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal dt As DataTable, ByVal fid As Integer,
        ...
        e.Graphics.DrawString("Cache  : " & avc & " Dhs", fnt, Brushes.Black, New RectangleF(10, l, 232, 22), sf)
    ...
    Public Sub RepportFacture(ByRef e As System.Drawing.Printing.PrintPageEventArgs,
        ...
        m = 0
    End Sub
    Public Sub RepportFactureRecept(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        'print Client 
        e.Graphics.DrawString("De " & Form1.dte1.Value.ToString("dd / MM / yyyy"), fnt, Brushes.Black, New RectangleF(15, 195, 275, 35), sf)
        e.Graphics.DrawString("Au " & Form1.dte2.Value.ToString("dd / MM / yyyy"), fnt, Brushes.Black, New RectangleF(15, 220, 275, 35), sf)
        ...
        Dim dA As New ALMohassinDBDataSetTableAdapters.ArticleTableAdapter
                    ...
                    For r As Integer = 0 To cat.Length - 1
                        ...
                        If dta.Rows.Count > 0 Then
                            For i As Integer = 0 To dta.Rows.Count - 1
                                ...
                                Dim ba
                                Try
                                        aa = dFTA.ScalarQueryArid(dt1, dt2, True, dta.Rows(i).Item(0))
    ...
    Public Sub RepportStock(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal data As DataGridView, ByRef m As Integer)
        ...
        'print date 
        e.Graphics.DrawString(dte.ToString("dd MMMM, yyyy"), fnt, Brushes.Black, 15, 130)

        e.Graphics.DrawString("Stock de groupe -" & Form1.DGVS.Tag, fntTitle, Brushes.Black, 15, 155)
        ...
        While m < data.Rows.Count
            ...
            e.Graphics.DrawString(Id, fnt, Brushes.Black, New RectangleF(10, l + 5, 15, 25), sf1)
            e.Graphics.DrawString("|", fnt, Brushes.Black, 32, l + 5)
            e.Graphics.DrawString(name, fnt, Brushes.Black, New RectangleF(36, l + 5, 200, 25), sf)
            e.Graphics.DrawString("|", fnt, Brushes.Black, 238, l + 5)
            e.Graphics.DrawString(value, fnt, Brushes.Black, New RectangleF(240, l + 5, 50, 25), sf1)
    ...
    Public Sub DrawCharges(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal data As DataGridView,
        ...
        m = 0
    End Sub
    Public Sub DrawReceptCharge(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal data As DataGridView,
                           ByVal MONTH As String, ByVal totalht As Double, ByVal dte As String, ByRef m As Integer)
        Try
        ...
        sf1.Alignment = StringAlignment.Far
            ...
            e.Graphics.DrawString(Form1.txttitle.Text, fntTitle, Brushes.Black, New RectangleF(10, 20, 300, 55), SFR)
            e.Graphics.DrawString(Form1.txtAdrs.Text, fnt, Brushes.Black, New RectangleF(10, 80, 300, 30), SFR)
            e.Graphics.DrawString(Form1.txttel.Text, fnt, Brushes.Black, New RectangleF(10, 100, 300, 30), SFR)
        ...
        e.Graphics.DrawString(dte, fnt, Brushes.Black, 15, 130)
            ...
            e.Graphics.DrawString("Charges : ", fntTitle, Brushes.Black, 15, 155)
            e.Graphics.DrawString(Form1.lbChargesMonth.Text, fnt, Brushes.Black, 15, 190)

            e.Graphics.DrawLine(pn, 10, l - 11, 300, l - 11)


            e.Graphics.DrawString("التاريخ", fnt, Brushes.Black, New RectangleF(235, l, 40, 25), sf)
            e.Graphics.DrawLine(pn, 232, l, 232, l + 23)
            e.Graphics.DrawString("المادة", fnt, Brushes.Black, New RectangleF(95, l, 135, 25), sf)
            e.Graphics.DrawLine(pn, 92, l, 92, l + 23)
            e.Graphics.DrawString("الميلغ", fnt, Brushes.Black, New RectangleF(10, l, 80, 25), SFR)
            l = l + 20
        ...
        While m < data.Rows.Count
            ...
            v += 1
                ...
                Dim dateCharge As String = CDate(data.Rows(m).Cells(1).Value).ToString("dd/MM/yy")
                Dim price As String = String.Format("{0:n}", CDec(data.Rows(m).Cells(3).Value))
                ''''''
                totalttc += CDec(data.Rows(m).Cells(3).Value)

                e.Graphics.DrawString(dateCharge, fnt, Brushes.Black, New RectangleF(235, l, 60, 25), sf)
                e.Graphics.DrawLine(pn, 232, l, 232, l + 20)
                e.Graphics.DrawString(name, fnt, Brushes.Black, New RectangleF(95, l, 135, 25), SFR)
                e.Graphics.DrawLine(pn, 92, l, 92, l + 20)
                e.Graphics.DrawString(price, fnt, Brushes.Black, New RectangleF(10, l, 80, 25), SFR)
        ...
        Dim Total As String = String.Format("{0:F}", totalht)
            ...
            e.Graphics.DrawString("Total  : ", fnt, Brushes.Black, New RectangleF(10, l, 200, 22), sf)
            e.Graphics.DrawString(Total & " (Dhs)", fntTitle, Brushes.Black, New RectangleF(10, l + 20, 220, 22), sf)
