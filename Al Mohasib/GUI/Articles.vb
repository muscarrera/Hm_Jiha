...
Public Class Articles
            ...
            Else
                ...
                For i As Integer = 0 To artdt.Rows.Count - 1
                    ...
                    DGVPRD.Rows.Add(artdt.Rows(i).Item("arid").ToString, artdt.Rows(i).Item("codebar").ToString,
                                    ...
                                    artdt.Rows(i).Item("qte").ToString, bt2.Tag, artdt.Rows(i).Item("Depot").ToString,
    ...
    Private Sub Button48_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button48.Click
        ...
        art.txtCatHammam.text = DGVPRD.SelectedRows(0).Cells(1).Value.ToString
        ...
        Try
            art.txtDetails.Text = DGVPRD.SelectedRows(0).Cells(14).Value
        Catch ex As Exception
            art.txtDetails.Text = ""
        End Try
    ...
    Private Sub Button34_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Panel3.Click, Label1.Click, Button34.Click, Panel5.Click, Panel4.Click, OvalShape3.Click, OvalShape2.Click, OvalShape1.Click, Label3.Click, Label2.Click, Button37.Click, Button36.Click
