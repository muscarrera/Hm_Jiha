...
Public Class Form1
    'members
    Private TrialName As String = "ALMsbtHammamFourthRun"
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If txtGroupe.Text.Contains("1") = False Then plHmm.Visible = False
            If txtGroupe.Text.Contains("2") = False Then plCoif.Visible = False
            If txtGroupe.Text.Contains("3") = False Then plTrk.Visible = False
            If txtGroupe.Text.Contains("4") = False Then plPrd.Visible = False
    ...
    Private Sub HandleRegistryinfo()
        ...
        getRegistryinfo(txtGroupe, "txtGroupe", "1-2-3-4")
        ...
        getRegistryinfo(cbOrderCtg, "cbOrderCtg", False)
        getRegistryinfo(cbDisableKeyNumber, "cbDisableKeyNumber", False)
    ...
    Private Function HandleRegistry2() As Integer
        ...
        If ALMohasibfirstRunDate = Nothing Then
            ...
            Try
                ...
                Dim val As String = ALMohasibfirstRunDate.Day & ALMohasibfirstRunDate.Hour & "-" & ALMohasibfirstRunDate.Second & "15-" & "2" & ALMohasibfirstRunDate.Year & "-4053-" & "2011" & ALMohasibfirstRunDate.Month
    ...
    Private Sub Button73_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button73.Click
        Try
            Try
                ...
                My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\SOFTWARE\AlMohassib", "cbOrderCtg", cbOrderCtg.Checked)
                My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\SOFTWARE\AlMohassib", "cbDisableKeyNumber", cbDisableKeyNumber.Checked)
    ...
    Private Sub RPl_SaveAndPrint(ByVal id As System.Int32, ByVal total As System.Double, ByVal avance As System.Double,
        ...
        If RPl.EditMode = False Then
            If isAdminFacture(RPl.FctId) Then
                Using a As SubClass = New SubClass(btswitsh.Tag)
        ...
        Try
            ...
            PrintDocSeparated.PrinterSettings.PrinterName = txttimp.Text
            ...
            If isSell Then
                For i = 1 To CInt(txtNbrCopie.Text) - 1
                    PrintDoc.Print()
                Next


                For i = 0 To table.Rows.Count - 1
                    If table.Rows(i).Item("cid") = 1 Then
                        RPl.selectedCid = 1
                        PrintDocSeparated.Print()
                        Exit For
                    End If
                Next
                ...
                For i = 0 To table.Rows.Count - 1
                    If table.Rows(i).Item("cid") = 2 Then
                        RPl.selectedCid = 2
                        PrintDocSeparated.Print()
                        Exit For
                    End If
                ...
                For i = 0 To table.Rows.Count - 1
                    If table.Rows(i).Item("cid") = 3 Then
                        RPl.selectedCid = 3
                        PrintDocSeparated.Print()
                        Exit For
                    End If
                ...
                For i = 0 To table.Rows.Count - 1
                    If table.Rows(i).Item("cid") >= 4 Then
                        RPl.selectedCid = 4
                        PrintDocSeparated.Print()
                        Exit For
                    End If
    ...
    Private Sub RPl_UpdateClient() Handles RPl.UpdateClient
        Using a As SubClass = New SubClass()
            a.UpdateClient(RPl.FctId, RPl.isSell)
        End Using
    ...
    Private Sub Button17_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button17.Click
        ...
        Dim str As String = " عند قيامكم على الضغط على 'موافق' سيتم تعديل تاريخ "
        str = str + vbNewLine
        str = str & RPl.ClientName & " ( " & RPl.FctId & ")"
        str = str + vbNewLine
        str = str + " من .." + DGVARFA.SelectedRows(0).Cells(6).Value
        str = str + vbNewLine
        str = str + " الى" + dte.ToString("dd, MMM yy")
        ...
        Using a As SubClass = New SubClass(btSwitch2.Tag)
            a.UpdateDateFacture(dte, RPl.FctId, RPl.isSell)
            DGVARFA.SelectedRows(0).Cells(6).Value = dte
        End Using
    End Sub
    ...
    Private Sub PrintDoc4_PrintPage(ByVal sender As System.Object,
        ...
        Try
            ...
            Using a As DrawClass = New DrawClass
                ...
                a.DrawReceptCharge(e, dgvCharge, lbChargesMonth.Text, CDbl(txtchtotal.Text),
    ...
    Private Sub Button29_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button29.Click
        ...
        Dim dt1 As Date = Date.Parse(dte2.Text).AddDays(1)
        Dim dt2 As Date = Date.Parse(dte1.Text)
        ...
        DGVARFA.ColumnHeadersVisible = True
            ...
            If txtArSearch.text <> "" Then
                If IsNumeric(txtArSearch.text) Then
                    Using a As DataAccess = New DataAccess(My.Settings.ALMohassinDBConnectionString)
                        ...
                        If adminId > 1 Then params.Add("writer = ", adminName)
    ...
    Private Sub Button30_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button30.Click
        ...
        DGVARFA.ColumnHeadersVisible = False
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbMsgOc.CheckedChanged, cbRTL.CheckedChanged
    ...
    Private Sub Button34_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button37.Click, Button36.Click, Button34.Click
        Using a As SubClass = New SubClass()
            '  a.ctg_click(sender, e)
            Dim bt As Button = sender

            a.FillGroupesHammam(bt.Tag)
        End Using
    End Sub

    Private Sub Button34_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button34.MouseHover
        RSHammam.BackColor = Button34.BackColor
    End Sub

    Private Sub Button34_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button34.MouseLeave
        RSHammam.BackColor = Button34.BackColor
    End Sub
    ...
    Private Sub Button38_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button38.Click
        ...
        If txtGroupe.Text.Contains("4") = True Then
            Try
        ...
        For z As Integer = 1 To 3
            Try
                If txtGroupe.Text.Contains(z) = True Then
                    Dim a, b
                    Try
                    ...
                    DGVARFA.Rows.Add(0, 0, STR(z), b, "_", "_", dt2.ToString("dd, MMM yy"),
                    "_", dt1.ToString("dd, MMM yy"), "_", "_", STR(z), "_", "_")
                    DGVARFA.Rows(0).DefaultCellStyle.BackColor = Color.BurlyWood
                    ...
                    If Not IsNothing(msg) Then
                        ...
                        For r As Integer = 0 To cat.Length - 1
                            ...
                            DGVARFA.Rows.Add(0, 0, cat(r), 0, 0 & " Dhs", "_")
                            IX = DGVARFA.Rows.Count - 1
                            DGVARFA.Rows(IX).DefaultCellStyle.BackColor = Color.Azure

                            If z = 1 And totalProduct > 0 Then
                                Try
                                    DGVARFA.Rows.Add(0, 0, "المواد", "",
                                                     String.Format("{0:n}", CDec(totalProduct)) & " Dhs", "_")
                                Catch ex As Exception
                                End Try
                            End If
                            ...
                            If dta.Rows.Count > 0 Then
                                For i As Integer = 0 To dta.Rows.Count - 1
                                    ...
                                    Try
                                        DGVARFA.Rows.Add(0, 0, dta.Rows(i).Item("name"), aa,
                                                         String.Format("{0:n}", CDec(ba)) & " Dhs", "_")
                                    Catch ex As Exception
                                    End Try
                                Next
                            End If
                            DGVARFA.Rows(IX).Cells(3).Value = ""
                            DGVARFA.Rows(IX).Cells(3).Value = String.Format("{0:n}", CDec(ttt))
                            dta = Nothing
                        Next
                    End If
                End If
        ...
        DGVARFA.Rows.Add(0, 0, "Total ", "", totalSell & " Dhs", "_")
        Dim iIX = DGVARFA.Rows.Count - 1
        DGVARFA.Rows(iIX).DefaultCellStyle.BackColor = Color.Red
        

        'Dim isSell As Boolean = CBool(btSwitch2.Tag)
        'Dim dt1 As Date = Date.Parse(dte2.Text).AddDays(1)
        'Dim dt2 As Date = Date.Parse(dte1.Text).AddDays(-1)
        'Dim factureableName As String = "Payment"
        'Dim tName As String = "Facture"
        'If isSell = False Then tName = "Bon"
        'If isSell = False Then tName = "CompanyPayment"
        ...
        'dt = FTA.GetDataBTotal(dt2, dt1)
        'Try
        '    Dim a = FTA.ScalarQueryCOUNT(dt1, dt2)
        '    Dim b = FTA.ScalarQueryTotal(dt1, dt2)
        '    Dim c = FTA.ScalarQueryAVC(dt1, dt2)

        '    DGVARFA.Rows.Add(0, 0, "Ventes", a, "_", "_", dt2.ToString("dd, MMM yy"),
        '                "_", dt1.ToString("dd, MMM yy"), "_", "_", "المبيعات", "_", "_")
        '    DGVARFA.Rows(0).DefaultCellStyle.BackColor = Color.BurlyWood

        '    DGVARFA.Rows.Add(0, 0, "Total", b, "_", "_", "_", "_", "_", "_", "_", "المجموع", "_", "_")
        '    DGVARFA.Rows.Add(0, 0, "Avance", c, "_", "_", "_", "_", "_", "_", "_", "الدفــع", "_", "_")
        '    DGVARFA.Rows.Add("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-")
        ...
        'Try
        '    Dim a = dFTA.ScalarQuerySumProduct(dt1, dt2, 4)

        '    If a > 0 Then
        '        DGVARFA.Rows.Add(0, 0, "PRODUIT", a, "Total", a, dt2.ToString("dd, MMM yy [hh:mm]"),
        '                        "_", dt1.ToString("dd, MMM yy [hh:mm]"), "_", "_", "المواد", "_", "_")
        '    End If
        ...
        'Try
        '    If txtGroupe.Text.Contains("1") = True Then
        '        Dim a = dFTA.ScalarQuerycount(dt1, dt2, 1)
        '        Dim b = dFTA.ScalarQuerySum(dt1, dt2, 1)
        '        DGVARFA.Rows.Add(0, 0, "HAMMAM", a, "Total", b, dt2.ToString("dd, MMM yy [hh:mm]"),
        '                  "_", dt1.ToString("dd, MMM yy [hh:mm]"), "_", "_", "حمام بلدي", "_", "_")

        '        DGVARFA.Rows(4).DefaultCellStyle.BackColor = Color.Azure


        '        Dim dta = dA.GetDataBycid(1)

        '        If dta.Rows.Count > 0 Then
        '            For i As Integer = 0 To dta.Rows.Count - 1
        '                Dim aa = dFTA.ScalarQueryArid(dt1, dt2, dta.Rows(i).Item(0))
        '                Dim ba = dFTA.ScalarQuerySumArid(dt1, dt2, dta.Rows(i).Item(0))

        '                DGVARFA.Rows.Add(0, 0, dta.Rows(i).Item("name"), aa, "Total", ba, " ",
        '                "_", " ", "_", "_", dta.Rows(i).Item("name"), "_", "_")
        '            Next
        '        End If
        '    End If
        'Catch ex As Exception
        ...
        'End Try
        'Try
        '    If txtGroupe.Text.Contains("2") = True Then


        '        Dim a = dFTA.ScalarQuerycount(dt1, dt2, 2)
        '        Dim b = dFTA.ScalarQuerySum(dt1, dt2, 2)
        '        DGVARFA.Rows.Add(0, 0, "COIFFURE", a, "Total", b, dt2.ToString("dd, MMM yy [hh:mm]"),
        '                 "_", dt1.ToString("dd, MMM yy [hh:mm]"), "_", "_", "الحــلاقه", "_", "_")

        '        DGVARFA.Rows(DGVARFA.Rows.Count - 1).DefaultCellStyle.BackColor = Color.Azure

        '        Dim dta = dA.GetDataBycid(2)
        ...
        'End Try
        'Try
        '    If txtGroupe.Text.Contains("3") = True Then


        '        Dim a = dFTA.ScalarQuerycount(dt1, dt2, 3)
        '        Dim b = dFTA.ScalarQuerySum(dt1, dt2, 3)
        '        DGVARFA.Rows.Add(0, 0, "TOURKI", a, "Total", b, dt2.ToString("dd, MMM yy [hh:mm]"),
        '                 "_", dt1.ToString("dd, MMM yy [hh:mm]"), "_", "_", "التركي", "_", "_")

        '        DGVARFA.Rows(DGVARFA.Rows.Count - 1).DefaultCellStyle.BackColor = Color.Azure

        '        Dim dta = dA.GetDataBycid(3)
        ...
        '    DGVARFA.Rows.Add(0, 0, "Achates", a, "_", "_", dt2.ToString("dd, MMM yy [hh:mm]"),
        '                "_", dt1.ToString("dd, MMM yy [hh:mm]"), "_", "_", "المشتريات", "_", "_")
        '    DGVARFA.Rows(DGVARFA.Rows.Count - 1).DefaultCellStyle.BackColor = Color.BurlyWood
        ...
        '    DGVARFA.Rows.Add(0, 0, "Charges", a, "_", "_", dt2.ToString("dd, MMM yy [hh:mm]"),
        '                "_", dt1.ToString("dd, MMM yy [hh:mm]"), "_", "_", "", "_", "_")
        '    DGVARFA.Rows(DGVARFA.Rows.Count - 1).DefaultCellStyle.BackColor = Color.BurlyWood
    ...
    Private Sub PrintDocSeparated_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocSeparated.PrintPage
        Try
            Using a As DrawClass = New DrawClass
                ...
                a.DrawBL_A5_Ar_Separated(e, RPl.DataSource, RPl.FctId, RPl.ClId,
                          RPl.ClientName, dte, RPl.Total_TTC, RPl.selectedCid, txtScale.Text)
            End Using
            myTva.Clear()
        Catch ex As Exception
            M = 0
